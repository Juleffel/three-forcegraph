...
var ngraph_quadtreebh$2 = function(options) {
  options = options || {};
  options.gravity = typeof options.gravity === 'number' ? options.gravity : -1;
  options.theta = typeof options.theta === 'number' ? options.theta : 0.8;
 ...
 * Manages a simulation of physical forces acting on bodies and springs.
 */
var ngraph_physics_simulator$2 = physicsSimulator$1;
...
function physicsSimulator$1(settings) {
  ...
  // We allow clients to override basic factory methods:
  var createQuadTree = settings.createQuadTree || ngraph_quadtreebh$2;
  var createBounds = settings.createBounds || bounds$2;
  var createDragForce = settings.createDragForce || dragForce$2;
  var createSpringForce = settings.createSpringForce || springForce$2;
  var integrate = settings.integrator || eulerIntegrator$2;
  var createBody = settings.createBody || createBody$2;
...
var ngraph_forcelayout$1 = createLayout$2;
var simulator$1 = ngraph_physics_simulator$2;
...
function createLayout$2(graph, physicsSettings) {
  ...
  var createSimulator = ngraph_physics_simulator$2;
  var physicsSimulator = createSimulator(physicsSettings);
...
var insertStack$4 = InsertStack$2;
...
var isSamePosition$4 = function isSamePosition(point1, point2) {
    var dx = Math.abs(point1.x - point2.x);
    var dy = Math.abs(point1.y - point2.y);
...
var ngraph_quadtreebh3d = function(options) {
  ...
  var random = ngraph_random.random(1984),
    Node = node$4,
    InsertStack = insertStack$4,
    isSamePosition = isSamePosition$4;
...
var bounds$4 = function (bodies, settings) {
  var random = ngraph_random.random(42);
...
var eulerIntegrator$4 = integrate$3;
